 ...
 * This file demonstrates how to integrate Yarnforge with a web frontend
 */

// For React/Vue/Angular applications
export class YarnforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new YarnforgeClient(provider, contractAddress);
